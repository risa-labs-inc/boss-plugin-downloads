...
**Downloads (Dynamic)** (`ai.rever.boss.plugin.dynamic.downloads`) is a dynamic plugin for the BOSS desktop application.

Displays active and completed downloads in a sidebar panel

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.downloads`
- **Main Class**: `ai.rever.boss.plugin.dynamic.downloads.DownloadsDynamicPlugin`
- **API Version**: 1.0.20
