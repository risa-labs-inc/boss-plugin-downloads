...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-downloads-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Downloads Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.downloads.DownloadsDynamicPlugin"
        )
    }
